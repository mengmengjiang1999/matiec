...
static bool is_profile_assert_invocation(
    const matiec::ParserState &parser_state, symbol_c *symbol) {
  ...
  if (!parser_state.options.register_experimental_assert || name == NULL ||
      strlen(name->value) != 6)
    return false;
...
identifier_c *il_operator_c_2_identifier_c(
    matiec::ParserState &parser_state, symbol_c *il_operator);
/* Convert an il_operator_c into an poutype_identifier_c */
poutype_identifier_c *il_operator_c_2_poutype_identifier_c(
    matiec::ParserState &parser_state, symbol_c *il_operator);


/* return if current token is a syntax element */
/* ERROR_CHECK_BEGIN */
bool is_current_syntax_token_value(int token);
#define is_current_syntax_token() is_current_syntax_token_value(yychar)
/* ERROR_CHECK_END */

/* print an error message */
void print_err_msg(const matiec::ParserState &parser_state, int first_line,
                   int first_column,
...
| library error library_element_declaration
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unknown syntax error."); yyerrok;}
...
/* ERROR_CHECK_BEGIN */
| integer_type_name signed_integer
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'#' missing between integer type name and value in integer literal."); parser_state.syntax_errors++;}
| integer_type_name binary_integer
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'#' missing between integer type name and value in integer literal."); parser_state.syntax_errors++;}
| integer_type_name octal_integer
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'#' missing between integer type name and value in integer literal."); parser_state.syntax_errors++;}
...
| integer_type_name '#' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no value defined for integer literal.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid value for integer literal."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| real_type_name signed_real
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'#' missing between real type name and value in real literal."); parser_state.syntax_errors++;}
| real_type_name '#' error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no value defined for real literal.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid value for real literal."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| bit_string_type_name integer
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'#' missing between bit string type name and value in bit string literal."); parser_state.syntax_errors++;}
| bit_string_type_name binary_integer
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'#' missing between bit string type name and value in bit string literal."); parser_state.syntax_errors++;}
| bit_string_type_name octal_integer
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'#' missing between bit string type name and value in bit string literal."); parser_state.syntax_errors++;}
...
| bit_string_type_name '#' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no value defined for bit string literal.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid value for bit string literal."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| TIME interval
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'#' missing between 'TIME' and interval in duration."); parser_state.syntax_errors++;}
| TIME '-' interval
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'#' missing between 'TIME' and interval in duration."); parser_state.syntax_errors++;}
| TIME '#' erroneous_interval_token
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid value for duration."); parser_state.syntax_errors++;}
| T_SHARP erroneous_interval_token
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid value for duration."); parser_state.syntax_errors++;}
| TIME '#' '-' erroneous_interval_token
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid value for duration."); parser_state.syntax_errors++;}
| T_SHARP '-' erroneous_interval_token
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid value for duration."); parser_state.syntax_errors++;}
...
/* ERROR_CHECK_BEGIN */
| TIME_OF_DAY daytime
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'#' missing between 'TIME_OF_DAY' and daytime in time of day."); parser_state.syntax_errors++;}
| TIME_OF_DAY '#' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no value defined for time of day.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid value for time of day."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| ':' day_minute ':' day_second
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@4), "no value defined for hours in daytime."); parser_state.syntax_errors++;}
| error ':' day_minute ':' day_second
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "invalid value defined for hours in daytime."); yyerrok;}
| day_hour day_minute ':' day_second
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between hours and minutes in daytime."); parser_state.syntax_errors++;}
| day_hour ':' ':' day_second
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no value defined for minutes in daytime."); parser_state.syntax_errors++;}
| day_hour ':' error ':' day_second
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid value defined for minutes in daytime."); yyerrok;}
| day_hour ':' day_minute day_second
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "':' missing between minutes and seconds in daytime."); parser_state.syntax_errors++;}
| day_hour ':' day_minute ':' error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@4), locf(@5), "no value defined for seconds in daytime.");}
	 else {print_err_msg(parser_state, locf(@5), locl(@5), "invalid value for seconds in daytime."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| DATE date_literal
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'#' missing between 'DATE' and date literal in date."); parser_state.syntax_errors++;}
| DATE '#' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no value defined for date.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid value for date."); yyclearin;}
	 yyerrok;
	}
| D_SHARP error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@1), locf(@2), "no value defined for date.");}
	 else {print_err_msg(parser_state, locf(@2), locl(@2), "invalid value for date."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| '-' month '-' day
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no value defined for year in date literal."); parser_state.syntax_errors++;}
| year month '-' day
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'-' missing between year and month in date literal."); parser_state.syntax_errors++;}
| year '-' '-' day
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no value defined for month in date literal."); parser_state.syntax_errors++;}
| year '-' error '-' day
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid value defined for month in date literal."); yyerrok;}
| year '-' month day
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "'-' missing between month and day in date literal."); parser_state.syntax_errors++;}
| year '-' month '-' error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@4), locf(@5), "no value defined for day in date literal.");}
	 else {print_err_msg(parser_state, locf(@5), locl(@5), "invalid value for day in date literal."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| DATE_AND_TIME date_literal '-' daytime
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'#' missing between 'DATE_AND_TIME' and date literal in date and time."); parser_state.syntax_errors++;}
| DATE_AND_TIME '#' '-' daytime
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no value defined for date literal in date and time."); parser_state.syntax_errors++;}
| DATE_AND_TIME '#' error '-' daytime
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid value for date literal in date and time."); yyerrok;}
| DATE_AND_TIME '#' date_literal daytime
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "'-' missing between date literal and daytime in date and time."); parser_state.syntax_errors++;}
| DATE_AND_TIME '#' date_literal '-' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@4), locf(@5), "no value defined for daytime in date and time.");}
	 else {print_err_msg(parser_state, locf(@5), locl(@5), "invalid value for daytime in date and time."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
data_type_declaration:
  TYPE type_declaration_list END_TYPE
	{$$ = new data_type_declaration_c($2, locloc(@$)); if (parser_state.options.conversion_functions) include_string(parser_state, (create_enumtype_conversion_functions_c::get_declaration($$)).c_str());}
/* ERROR_CHECK_BEGIN */
| TYPE END_TYPE
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no data type declared in data type(s) declaration."); parser_state.syntax_errors++;}
| TYPE error type_declaration_list END_TYPE
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'TYPE' in data type(s) declaration."); yyerrok;}
| TYPE type_declaration_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed data type(s) declaration."); yyerrok;}
| TYPE error END_TYPE
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in data type(s) declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| error ';'
	{$$ = new type_declaration_list_c(locloc(@$)); print_err_msg(parser_state, locf(@1), locl(@1), "invalid data type declaration."); yyerrok;}
| type_declaration error
	{$$ = new type_declaration_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at end of data type declaration."); yyerrok;}
| type_declaration_list type_declaration error
	{$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at end of data type declaration."); yyerrok;}
| type_declaration_list error ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid data type declaration."); yyerrok;}
| type_declaration_list ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after data type declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
| error ':' simple_spec_init
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "invalid name defined for data type declaration.");yyerrok;}
| identifier simple_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between data type name and specification in simple type declaration."); parser_state.syntax_errors++;}
| identifier ':' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no specification defined in data type declaration.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid specification in data type declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| elementary_type_name constant
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' missing in specification with initialization."); parser_state.syntax_errors++;}
| prev_declared_simple_type_name constant
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' missing in specification with initialization."); parser_state.syntax_errors++;}
| elementary_type_name ASSIGN error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no initial value defined in specification with initialization.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid initial value in specification with initialization."); yyclearin;}
	 yyerrok;
	}
...
| identifier subrange_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between data type name and specification in subrange type declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
| subrange_specification signed_integer
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' missing in subrange specification with initialization."); parser_state.syntax_errors++;}
| subrange_specification ASSIGN error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no initial value defined in subrange specification with initialization.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid initial value in subrange specification with initialization."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| integer_type_name '(' ')'
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no subrange defined in subrange specification."); parser_state.syntax_errors++;}
| integer_type_name '(' error ')'
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid subrange defined in subrange specification."); yyerrok;}
| integer_type_name '(' subrange error
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "')' missing after subrange defined in subrange specification."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| any_identifier DOTDOT signed_integer
	{$$ = new subrange_c(new symbolic_constant_c($1, locloc(@1)), $3, locloc(@$));
	 if (!parser_state.options.nonliteral_in_array_size) {
	   print_err_msg(parser_state, locf(@1), locl(@1), "Use of variables in array size limits is not allowed in IEC 61131-3 (use -a option to activate support for this non-standard feature).");
...
| signed_integer DOTDOT any_identifier
	{$$ = new subrange_c($1, new symbolic_constant_c($3, locloc(@3)), locloc(@$));
	 if (!parser_state.options.nonliteral_in_array_size) {
	   print_err_msg(parser_state, locf(@3), locl(@3), "Use of variables in array size limits is not allowed in IEC 61131-3 (use -a option to activate support for this non-standard feature).");
	   parser_state.syntax_errors++;
	 }
	}
| any_identifier DOTDOT any_identifier
	{$$ = new subrange_c(new symbolic_constant_c($1, locloc(@1)), new symbolic_constant_c($3, locloc(@3)), locloc(@$));
	 if (!parser_state.options.nonliteral_in_array_size) {
	   print_err_msg(parser_state, locf(@$), locl(@$), "Use of variables in array size limits is not allowed in IEC 61131-3 (use -a option to activate support for this non-standard feature).");
	   parser_state.syntax_errors++;
	 }
	}
/* ERROR_CHECK_BEGIN */
| signed_integer signed_integer
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'..' missing between bounds in subrange definition."); parser_state.syntax_errors++;}
| signed_integer DOTDOT error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no value defined for upper bound in subrange definition.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid value for upper bound in subrange definition."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| error ':' enumerated_spec_init
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "invalid name defined for enumerated type declaration."); yyerrok;}
| identifier enumerated_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between data type name and specification in enumerated type declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
| enumerated_specification enumerated_value
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' missing in enumerated specification with initialization."); parser_state.syntax_errors++;}
| enumerated_specification ASSIGN error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no value defined in enumerated specification with initialization.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid value in enumerated specification with initialization."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| '(' ')'
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no enumerated value list defined in enumerated specification."); parser_state.syntax_errors++;}
| '(' error ')'
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid enumerated value list defined in enumerated specification.");yyerrok;}
| '(' enumerated_value_list error
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "')' missing at the end of enumerated specification."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| enumerated_value_list enumerated_value
	{$$ = $1; print_err_msg(parser_state, locl(@1), locf(@2), "',' missing in enumerated value list.");}
| enumerated_value_list ',' error
	{$$ = $1;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no value defined in enumerated value list.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid value in enumerated value list."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| prev_declared_enumerated_type_name any_identifier
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'#' missing between enumerated type name and value in enumerated literal."); parser_state.syntax_errors++;}
| prev_declared_enumerated_type_name '#' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no value defined for enumerated literal.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid value for enumerated literal."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| array_specification array_initialization
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' missing in array specification with initialization."); parser_state.syntax_errors++;}
| array_specification ASSIGN error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no initial value defined in array specification with initialization.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid initial value in array specification with initialization."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| ARRAY array_subrange_list ']' OF non_generic_type_name
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'[' missing before subrange list in array specification."); parser_state.syntax_errors++;}
| ARRAY '[' ']' OF non_generic_type_name
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no subrange list defined in array specification."); parser_state.syntax_errors++;}
| ARRAY '[' error ']' OF non_generic_type_name
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid subrange list defined in array specification."); yyerrok;}
| ARRAY OF non_generic_type_name
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no subrange list defined in array specification."); parser_state.syntax_errors++;}
| ARRAY error OF non_generic_type_name
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid subrange list defined in array specification."); yyerrok;}
| ARRAY '[' array_subrange_list OF non_generic_type_name
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "']' missing after subrange list in array specification."); parser_state.syntax_errors++;}
| ARRAY '[' array_subrange_list ']' non_generic_type_name
	{$$ = NULL; print_err_msg(parser_state, locl(@4), locf(@5), "'OF' missing between subrange list and item type name in array specification."); parser_state.syntax_errors++;}
| ARRAY '[' array_subrange_list ']' OF error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no item data type defined in array specification.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid item data type in array specification."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| array_subrange_list subrange
	{$$ = $1; print_err_msg(parser_state, locl(@1), locf(@2), "',' missing in subrange list."); parser_state.syntax_errors++;}
| array_subrange_list ',' error
	{$$ = $1;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no subrange defined in subrange list.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid subrange in subrange list."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| '[' ']'
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no initial values list defined in array initialization."); parser_state.syntax_errors++;}
| '[' error ']'
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid initial values list defined in array initialization."); yyerrok;}
| '[' array_initial_elements_list error
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "']' missing at the end of array initialization."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| array_initial_elements_list ',' error
	{$$ = $1;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no array initial value in array initial values list.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid array initial value in array initial values list."); yyclearin;}
	 yyerrok;
	}
*/
/* ERROR_CHECK_END */
...
/* ERROR_CHECK_BEGIN */
| integer '(' error ')'
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid array initial value in array initial values list."); yyerrok;}
| integer '(' array_initial_element error
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "')' missing at the end of array initial value in array initial values list."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| prev_declared_structure_type_name structure_initialization
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' missing in structure specification with initialization."); parser_state.syntax_errors++;}
| prev_declared_structure_type_name ASSIGN error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no value defined in structure specification with initialization.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid value in structure specification with initialization."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| STRUCT END_STRUCT
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no structure element declared in structure type declaration."); parser_state.syntax_errors++;}
| STRUCT error structure_element_declaration_list END_STRUCT
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'STRUCT' in structure type declaration."); yyerrok;}
| STRUCT structure_element_declaration_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed structure type declaration."); yyerrok;}
| STRUCT error END_STRUCT
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in structure type declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| error ';'
	{$$ = new structure_element_declaration_list_c(locloc(@$)); print_err_msg(parser_state, locf(@1), locl(@1), "invalid structure element declaration."); yyerrok;}
| structure_element_declaration error
	{$$ = new structure_element_declaration_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at end of structure element declaration."); yyerrok;}
| structure_element_declaration_list structure_element_declaration error
	{$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at end of structure element declaration."); yyerrok;}
| structure_element_declaration_list error ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid structure element declaration."); yyerrok;}
| structure_element_declaration_list ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after structure element declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| structure_element_name simple_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between structure element name and simple specification."); parser_state.syntax_errors++;}
| structure_element_name subrange_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between structure element name and subrange specification."); parser_state.syntax_errors++;}
| structure_element_name enumerated_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between structure element name and enumerated specification."); parser_state.syntax_errors++;}
| structure_element_name array_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between structure element name and array specification."); parser_state.syntax_errors++;}
| structure_element_name initialized_structure
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between structure element name and structure specification."); parser_state.syntax_errors++;}
| structure_element_name ':' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no specification defined in structure element declaration.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid specification in structure element declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| '(' error ')'
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid structure element initialization list in structure initialization."); yyerrok;}
| '(' structure_element_initialization_list error
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "expecting ')' at the end of structure element initialization list in structure initialization."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/*
| structure_element_initialization_list structure_element_initialization
	{$$ = $1; print_err_msg(parser_state, locl(@1), locf(@2), "',' missing in structure element initialization list in structure initialization."); parser_state.syntax_errors++;}
| structure_element_initialization_list ',' error
	{$$ = $1;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no structure element initialization defined in structure initialization.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid structure element initialization in structure initialization."); yyclearin;}
	 yyerrok;
	}
*/
/* ERROR_CHECK_END */
...
| structure_element_name constant
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' missing in structure element initialization."); parser_state.syntax_errors++;}
| structure_element_name enumerated_value
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' missing in enumerated structure element initialization."); parser_state.syntax_errors++;}
| structure_element_name array_initialization
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' missing in array structure element initialization."); parser_state.syntax_errors++;}
| structure_element_name structure_initialization
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' missing in structured structure element initialization."); parser_state.syntax_errors++;}
| structure_element_name ASSIGN error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no initial value defined in structured structure element initialization.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid initial value in structured structure element initialization."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| ref_spec ASSIGN ref_value_null_literal
	{$$ = new ref_spec_init_c($1, $3, locloc(@$));
	 if (!parser_state.options.iec2025_experimental) {
	   print_err_msg(parser_state, locf(@$), locl(@$), "REF_TO initialization is experimental (use --std=iec61131-3:2025-experimental).");
	   parser_state.syntax_errors++;
	 }
	}
;
...
| record_variable '.' il_simple_operator_clash3
    {$$ = new structured_variable_c($1, il_operator_c_2_identifier_c(parser_state, $3), locloc(@$));}
;
...
/* ERROR_CHECK_BEGIN */
| VAR_INPUT END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no variable declared in input variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_INPUT RETAIN END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable declared in retentive input variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_INPUT NON_RETAIN END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable declared in non-retentive input variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_INPUT error input_declaration_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'VAR_INPUT' in input variable(s) declaration."); yyerrok;}
| VAR_INPUT RETAIN error input_declaration_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'RETAIN' in retentive input variable(s) declaration."); yyerrok;}
| VAR_INPUT NON_RETAIN error input_declaration_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'NON_RETAIN' in non-retentive input variable(s) declaration."); yyerrok;}
| VAR_INPUT input_declaration_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed input variable(s) declaration."); yyerrok;}
| VAR_INPUT RETAIN input_declaration_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed retentive input variable(s) declaration."); yyerrok;}
| VAR_INPUT NON_RETAIN input_declaration_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed non-retentive input variable(s) declaration."); yyerrok;}
| VAR_INPUT error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in input variable(s) declaration."); yyerrok;}
| VAR_INPUT RETAIN error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unknown error in retentive input variable(s) declaration."); yyerrok;}
| VAR_INPUT NON_RETAIN error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unknown error in non-retentive input variable(s) declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| error ';'
	{$$ = new input_declaration_list_c(locloc(@$)); print_err_msg(parser_state, locf(@1), locl(@1), "invalid input variable(s) declaration."); yyerrok;}
| input_declaration error
	{$$ = new input_declaration_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at end of input variable(s) declaration."); yyerrok;}
| input_declaration_list input_declaration error
	{$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at end of input variable(s) declaration."); yyerrok;}
| input_declaration_list error ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid input variable(s) declaration."); yyerrok;}
| input_declaration_list ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after input variable(s) declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| var1_list BOOL R_EDGE
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between variable list and specification in edge declaration."); parser_state.syntax_errors++;}
| var1_list BOOL F_EDGE
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between variable list and specification in edge declaration."); parser_state.syntax_errors++;}
| var1_list ':' BOOL R_EDGE F_EDGE
	{$$ = NULL; print_err_msg(parser_state, locl(@5), locf(@5), "'R_EDGE' and 'F_EDGE' can't be present at the same time in edge declaration."); parser_state.syntax_errors++;}
| var1_list ':' BOOL F_EDGE R_EDGE
	{$$ = NULL; print_err_msg(parser_state, locl(@5), locf(@5), "'R_EDGE' and 'F_EDGE' can't be present at the same time in edge declaration."); parser_state.syntax_errors++;}
| var1_list ':' R_EDGE
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "'BOOL' missing in edge declaration."); parser_state.syntax_errors++;}
| var1_list ':' F_EDGE
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "'BOOL' missing in edge declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| en_identifier BOOL ASSIGN boolean_literal
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between variable list and specification in EN declaration."); parser_state.syntax_errors++;}
| en_identifier BOOL ASSIGN integer
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between variable list and specification in EN declaration."); parser_state.syntax_errors++;}
| en_identifier ':' ASSIGN boolean_literal
  {$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "'BOOL' missing in EN declaration."); parser_state.syntax_errors++;}
| en_identifier ':' ASSIGN integer
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "'BOOL' missing in EN declaration."); parser_state.syntax_errors++;}
| en_identifier ':' BOOL ASSIGN error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no specification defined in EN declaration.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid specification in EN declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| var1_list simple_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between variable list and simple specification."); parser_state.syntax_errors++;}
| var1_list subrange_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between variable list and subrange specification."); parser_state.syntax_errors++;}
| var1_list enumerated_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between variable list and enumerated specification."); parser_state.syntax_errors++;}
| var1_list ':' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no specification defined in variable declaration.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid specification in variable declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| var1_list variable_name
	{$$ = $1; print_err_msg(parser_state, locl(@1), locf(@2), "',' missing in variable list."); parser_state.syntax_errors++;}
| var1_list ',' error
	{$$ = $1;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no variable name defined in variable declaration.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid variable name in variable declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| var1_list array_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between variable list and array specification."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| var1_list initialized_structure
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between variable list and structured specification."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
| fb_name_list_with_colon ASSIGN structure_initialization
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no function block type name defined in function block declaration with initialization."); parser_state.syntax_errors++;}
| fb_name_list_with_colon function_block_type_name structure_initialization
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "':=' missing in function block declaration with initialization."); parser_state.syntax_errors++;}
| fb_name_list_with_colon function_block_type_name ASSIGN error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@3), locf(@4), "no initialization defined in function block declaration.");}
	 else {print_err_msg(parser_state, locf(@4), locl(@4), "invalid initialization in function block declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| VAR_OUTPUT END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no variable declared in output variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_OUTPUT RETAIN END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable declared in retentive output variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_OUTPUT NON_RETAIN END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable declared in non-retentive output variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_OUTPUT error var_output_init_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'VAR_OUPUT' in output variable(s) declaration."); yyerrok;}
| VAR_OUTPUT RETAIN error var_output_init_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'RETAIN' in retentive output variable(s) declaration."); yyerrok;}
| VAR_OUTPUT NON_RETAIN error var_output_init_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'NON_RETAIN' in non-retentive output variable(s) declaration."); yyerrok;}
| VAR_OUTPUT var_output_init_decl_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed output variable(s) declaration."); yyerrok;}
| VAR_OUTPUT RETAIN var_output_init_decl_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed retentive output variable(s) declaration."); yyerrok;}
| VAR_OUTPUT NON_RETAIN var_output_init_decl_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed non-retentive output variable(s) declaration."); yyerrok;}
| VAR_OUTPUT error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in output variable(s) declaration."); yyerrok;}
| VAR_OUTPUT RETAIN error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unknown error in retentive output variable(s) declaration."); yyerrok;}
| VAR_OUTPUT NON_RETAIN error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unknown error in non-retentive output variable(s) declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| var_output_init_decl_list var_output_init_decl error
	{$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at end of variable(s) declaration."); yyerrok;}
| var_output_init_decl_list error ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid variable(s) declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| eno_identifier BOOL
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between variable list and specification in ENO declaration."); parser_state.syntax_errors++;}
| eno_identifier ':' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no specification defined in ENO declaration.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid specification in ENO declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| VAR_IN_OUT END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no variable declared in in_out variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_IN_OUT error var_declaration_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'VAR_IN_OUT' in in_out variable(s) declaration."); yyerrok;}
| VAR_IN_OUT var_declaration_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed in_out variable(s) declaration."); yyerrok;}
| VAR_IN_OUT error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in in_out variable(s) declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| error ';'
	{$$ = new var_declaration_list_c(locloc(@$)); print_err_msg(parser_state, locf(@1), locl(@1), "invalid variable(s) declaration."); yyerrok;}
| var_declaration error
	{$$ = new var_declaration_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at end of variable(s) declaration."); yyerrok;}
| var_declaration_list var_declaration error
	{$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at end of variable(s) declaration."); yyerrok;}
| var_declaration_list error ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid variable(s) declaration."); yyerrok;}
| var_declaration_list ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after variable(s) declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| VAR END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no variable declared in variable(s) declaration."); parser_state.syntax_errors++;}
| VAR CONSTANT END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable declared in constant variable(s) declaration."); parser_state.syntax_errors++;}
| VAR error var_init_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@3), "unexpected token after 'VAR' in variable(s) declaration."); yyerrok;}
| VAR CONSTANT error var_init_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'CONSTANT' in constant variable(s) declaration."); yyerrok;}
| VAR var_init_decl_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed variable(s) declaration."); yyerrok;}
| VAR CONSTANT var_init_decl_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed constant variable(s) declaration."); yyerrok;}
| VAR error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in variable(s) declaration."); yyerrok;}
| VAR CONSTANT error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unknown error in constant variable(s) declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| VAR RETAIN END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable declared in retentive variable(s) declaration."); parser_state.syntax_errors++;}
| VAR RETAIN error var_init_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'RETAIN' in retentive variable(s) declaration."); yyerrok;}
| VAR RETAIN var_init_decl_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed retentive variable(s) declaration."); yyerrok;}
| VAR RETAIN error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unknown error in retentive variable(s) declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| VAR NON_RETAIN END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable declared in non-retentive located variable(s) declaration."); parser_state.syntax_errors++;}
| VAR error located_var_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'VAR' in located variable(s) declaration."); yyerrok;}
| VAR CONSTANT error located_var_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'CONSTANT' in constant located variable(s) declaration."); yyerrok;}
| VAR RETAIN error located_var_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'RETAIN' in retentive located variable(s) declaration."); yyerrok;}
| VAR NON_RETAIN error located_var_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'NON_RETAIN' in non-retentive located variable(s) declaration."); yyerrok;}
| VAR located_var_decl_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed located variable(s) declaration."); yyerrok;}
| VAR CONSTANT located_var_decl_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed constant located variable(s) declaration."); yyerrok;}
| VAR RETAIN located_var_decl_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed retentive located variable(s) declaration."); yyerrok;}
| VAR NON_RETAIN located_var_decl_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed non-retentive located variable(s) declaration."); yyerrok;}
| VAR NON_RETAIN error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unknown error in non retentive variable(s) declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| error ';'
	{$$ = new located_var_decl_list_c(locloc(@$)); print_err_msg(parser_state, locf(@1), locl(@1), "invalid located variable declaration."); yyerrok;}
| located_var_decl error
	{$$ = new located_var_decl_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at end of located variable declaration."); yyerrok;}
| located_var_decl_list located_var_decl error
	{$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at end of located variable declaration."); yyerrok;}
| located_var_decl_list error ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid located variable declaration."); yyerrok;}
| located_var_decl_list ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after located variable declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| variable_name location located_var_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between located variable location and specification."); parser_state.syntax_errors++;}
| location located_var_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between located variable location and specification."); parser_state.syntax_errors++;}
| variable_name location ':' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no specification defined in located variable declaration.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid specification in located variable declaration."); yyclearin;}
	 yyerrok;
	}
| location ':' error
	{$$ = NULL;
...
/* ERROR_CHECK_BEGIN */
| VAR_EXTERNAL END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no variable declared in external variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_EXTERNAL CONSTANT END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable declared in constant external variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_EXTERNAL error external_declaration_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'VAR_EXTERNAL' in external variable(s) declaration."); yyerrok;}
| VAR_EXTERNAL CONSTANT error external_declaration_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'CONSTANT' in constant external variable(s) declaration."); yyerrok;}
| VAR_EXTERNAL external_declaration_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed external variable(s) declaration."); yyerrok;}
| VAR_EXTERNAL CONSTANT external_declaration_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed constant external variable(s) declaration."); yyerrok;}
| VAR_EXTERNAL error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in external variable(s) declaration."); yyerrok;}
| VAR_EXTERNAL CONSTANT error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unknown error in constant external variable(s) declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| error ';'
	{$$ = new external_declaration_list_c(locloc(@$)); print_err_msg(parser_state, locf(@1), locl(@1), "invalid external variable declaration."); yyerrok;}
| external_declaration error
	{$$ = new external_declaration_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at end of external variable declaration."); yyerrok;}
| external_declaration_list external_declaration error
	{$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at end of external variable declaration."); yyerrok;}
| external_declaration_list error ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid external variable declaration."); yyerrok;}
| external_declaration_list ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after external variable declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| global_var_name simple_specification
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between external variable name and simple specification."); parser_state.syntax_errors++;}
| global_var_name subrange_specification
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between external variable name and subrange specification."); parser_state.syntax_errors++;}
| global_var_name enumerated_specification
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between external variable name and enumerated specification."); parser_state.syntax_errors++;}
| global_var_name array_specification
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between external variable name and array specification."); parser_state.syntax_errors++;}
| global_var_name prev_declared_structure_type_name
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between external variable name and structured specification."); parser_state.syntax_errors++;}
| global_var_name function_block_type_name
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between external variable name and function block type specification."); parser_state.syntax_errors++;}
| global_var_name ':' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no specification defined in external variable declaration.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid specification in external variable declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| VAR_GLOBAL END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no variable declared in global variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_GLOBAL CONSTANT END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable declared in constant global variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_GLOBAL RETAIN END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable declared in retentive global variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_GLOBAL error global_var_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'VAR_GLOBAL' in global variable(s) declaration."); yyerrok;}
| VAR_GLOBAL CONSTANT error global_var_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'CONSTANT' in constant global variable(s) declaration."); yyerrok;}
| VAR_GLOBAL RETAIN error global_var_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'RETAIN' in retentive global variable(s) declaration."); yyerrok;}
| VAR_GLOBAL global_var_decl_list error END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed global variable(s) declaration."); yyerrok;}
| VAR_GLOBAL CONSTANT global_var_decl_list error END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed constant global variable(s) declaration."); yyerrok;}
| VAR_GLOBAL RETAIN global_var_decl_list error END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed retentive global variable(s) declaration."); yyerrok;}
| VAR_GLOBAL error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in global variable(s) declaration."); yyerrok;}
| VAR_GLOBAL CONSTANT error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unknown error in constant global variable(s) declaration."); yyerrok;}
...
/* ERROR_CHECK_BEGIN */
| error ';'
	{$$ = new global_var_decl_list_c(locloc(@$)); print_err_msg(parser_state, locf(@1), locl(@1), "invalid global variable(s) declaration."); yyerrok;}
| global_var_decl error
	{$$ = new global_var_decl_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at end of global variable(s) declaration."); yyerrok;}
| global_var_decl_list global_var_decl error
	{$$ = $1; print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at end of global variable(s) declaration."); yyerrok;}
| global_var_decl_list error ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid global variable(s) declaration."); yyerrok;}
| global_var_decl_list ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after global variable(s) declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
| global_var_list located_var_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between global variable list and type specification."); parser_state.syntax_errors++;}
| global_var_name location located_var_spec_init
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between global variable specification and type specification."); parser_state.syntax_errors++;}
| global_var_spec function_block_type_name
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between global variable specification and function block type specification."); parser_state.syntax_errors++;}
| global_var_spec ':' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no specification defined in global variable declaration.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid specification in global variable declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| AT error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@1), locf(@2), "no location defined in location declaration.");}
	 else {print_err_msg(parser_state, locf(@2), locl(@2), "invalid location in global location declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| global_var_list global_var_name
	{$$ = new global_var_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "',' missing in global variable list."); parser_state.syntax_errors++;}
| global_var_list ',' error
	{$$ = $1;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no variable name defined in global variable declaration.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid variable name in global variable declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| var1_list single_byte_string_spec
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between variable list and string type specification."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| STRING '[' error ']'
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid length value for limited string type specification."); yyerrok;}
| STRING '[' error ']' ASSIGN single_byte_character_string
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid length value for limited string type specification."); yyerrok;}
| STRING '[' ']'
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "missing length value for limited string type specification."); parser_state.syntax_errors++;}
| STRING '[' ']' ASSIGN single_byte_character_string
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "missing length value for limited string type specification."); parser_state.syntax_errors++;}
| STRING '[' integer error
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "expecting ']' after length definition for limited string type specification."); yyerrok;}
| STRING '[' integer ']' single_byte_character_string
	{$$ = NULL; print_err_msg(parser_state, locl(@4), locf(@5), "':=' missing before limited string type initialization."); parser_state.syntax_errors++;}
| STRING '[' integer ']' ASSIGN error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@5), locf(@6), "no initial value defined in limited string type initialization.");}
	 else {print_err_msg(parser_state, locf(@6), locl(@6), "invalid initial value in limited string type initialization."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| var1_list double_byte_string_spec
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between variable list and double byte string type specification."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| WSTRING '[' error ']'
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid length value for limited double byte string type specification."); yyerrok;}
| WSTRING '[' error ']' ASSIGN single_byte_character_string
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid length value for limited double byte string type specification."); yyerrok;}
| WSTRING '[' ']'
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "missing length value for limited double byte string type specification."); parser_state.syntax_errors++;}
| WSTRING '[' ']' ASSIGN single_byte_character_string
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "missing length value for limited double byte string type specification."); parser_state.syntax_errors++;}
| WSTRING '[' integer error
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "expecting ']' after length definition for limited double byte string type specification."); yyerrok;}
| WSTRING '[' integer ']' single_byte_character_string
	{$$ = NULL; print_err_msg(parser_state, locl(@4), locf(@5), "':=' missing before limited double byte string type initialization."); parser_state.syntax_errors++;}
| WSTRING '[' integer ']' ASSIGN error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@5), locf(@6), "no initial value defined double byte in limited string type initialization.");}
	 else {print_err_msg(parser_state, locf(@6), locl(@6), "invalid initial value in limited double byte string type initialization."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| VAR incompl_located_var_decl_list error END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed incomplete located variable(s) declaration."); yyerrok;}
| VAR RETAIN incompl_located_var_decl_list error END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed incomplete retentive located variable(s) declaration."); yyerrok;}
| VAR NON_RETAIN incompl_located_var_decl_list error END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed incomplete non-retentive located variable(s) declaration."); yyerrok;}
| VAR error incompl_located_var_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'VAR' in incomplete located variable(s) declaration."); yyerrok;}
...
| incompl_located_var_decl error
	{$$ = new incompl_located_var_decl_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at end of incomplete located variable declaration."); yyerrok;}
| incompl_located_var_decl_list incompl_located_var_decl error
	{$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at end of incomplete located variable declaration."); yyerrok;}
| incompl_located_var_decl_list error ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid incomplete located variable declaration."); yyerrok;}
| incompl_located_var_decl_list ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after incomplete located variable declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| variable_name incompl_location var_spec
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing between incomplete located variable and type specification."); parser_state.syntax_errors++;
	}
| variable_name incompl_location ':' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no specification defined in incomplete located variable declaration.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid specification in incomplete located variable declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
standard_function_name_NOT_clashes:
  NOT
	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "NOT"), locloc(@$));}
;
...
standard_function_name_expression_clashes:
  AND	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "AND"), locloc(@$));}
| OR	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "OR"), locloc(@$));}
| XOR	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "XOR"), locloc(@$));}
| ADD	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "ADD"), locloc(@$));}
| SUB	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "SUB"), locloc(@$));}
| MUL	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "MUL"), locloc(@$));}
| DIV	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "DIV"), locloc(@$));}
| MOD	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "MOD"), locloc(@$));}
| GT	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "GT"), locloc(@$));}
| GE	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "GE"), locloc(@$));}
| EQ	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "EQ"), locloc(@$));}
| LT	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "LT"), locloc(@$));}
| LE	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "LE"), locloc(@$));}
| NE	{$$ = new poutype_identifier_c(matiec::retain_ast_string(parser_state, "NE"), locloc(@$));}
/*
  AND_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
//NOTE: AND2 (corresponding to the source code string '&') does not clash
//      with a standard function name, so should be commented out!
//| AND2_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
| OR_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
| XOR_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
| ADD_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
| SUB_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
| MUL_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
| DIV_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
| MOD_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
| GT_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
| GE_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
| EQ_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
| LT_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
| LE_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
| NE_operator	{$$ = il_operator_c_2_poutype_identifier_c(parser_state, $1);}
*/
;
...
/* ERROR_CHECK_BEGIN */
| function_name_declaration elementary_type_name io_OR_function_var_declarations_list function_body END_FUNCTION
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing after function name in function declaration."); parser_state.syntax_errors++;}
| function_name_declaration derived_type_name io_OR_function_var_declarations_list function_body END_FUNCTION
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing after function name in function declaration."); parser_state.syntax_errors++;}
| function_name_declaration ':' io_OR_function_var_declarations_list function_body END_FUNCTION
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no return type defined in function declaration."); parser_state.syntax_errors++;}
| function_name_declaration ':' error io_OR_function_var_declarations_list function_body END_FUNCTION
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid return type defined in function declaration."); yyerrok;}
| function_name_declaration ':' elementary_type_name function_body END_FUNCTION
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "no variable(s) declared in function declaration."); parser_state.syntax_errors++;}
...
| function_name_declaration ':' elementary_type_name io_OR_function_var_declarations_list END_FUNCTION
	{$$ = NULL; print_err_msg(parser_state, locl(@4), locf(@5), "no body defined in function declaration."); parser_state.syntax_errors++;}
...
| function_name_declaration ':' elementary_type_name END_FUNCTION
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "no variable(s) declared and body defined in function declaration."); parser_state.syntax_errors++;}
...
| function_name_declaration ':' elementary_type_name io_OR_function_var_declarations_list function_body END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locf(@3), "unclosed function declaration."); parser_state.syntax_errors++;}
| function_name_declaration ':' derived_type_name io_OR_function_var_declarations_list function_body END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@3), "unclosed function declaration."); parser_state.syntax_errors++;}
| function_name_declaration error END_FUNCTION
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in function declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| FUNCTION error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@1), locf(@2), "no function name defined in function declaration.");}
	 else {print_err_msg(parser_state, locf(@2), locl(@2), "invalid function name in function declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| io_OR_function_var_declarations_list retentive_var_declarations
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected retentive variable(s) declaration in function declaration."); parser_state.syntax_errors++;}
| io_OR_function_var_declarations_list located_var_declarations
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected located variable(s) declaration in function declaration."); parser_state.syntax_errors++;}
| io_OR_function_var_declarations_list external_var_declarations
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected external variable(s) declaration in function declaration."); parser_state.syntax_errors++;}
| io_OR_function_var_declarations_list global_var_declarations
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected global variable(s) declaration in function declaration."); parser_state.syntax_errors++;}
| io_OR_function_var_declarations_list incompl_located_var_declarations
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected incomplete located variable(s) declaration in function declaration."); parser_state.syntax_errors++;}
| io_OR_function_var_declarations_list temp_var_decls
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected temporary located variable(s) declaration in function declaration."); parser_state.syntax_errors++;}
| io_OR_function_var_declarations_list non_retentive_var_decls
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected non-retentive variable(s) declaration in function declaration."); parser_state.syntax_errors++;}
/*| io_OR_function_var_declarations_list access_declarations
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected access variable(s) declaration in function declaration."); parser_state.syntax_errors++;}*/
| io_OR_function_var_declarations_list instance_specific_initializations
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected instance specific initialization(s) in function declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
| VAR error var2_init_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'VAR' in function variable(s) declaration."); yyerrok;}
| VAR CONSTANT error var2_init_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'CONSTANT' in constant function variable(s) declaration."); yyerrok;}
| VAR var2_init_decl_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed function variable(s) declaration."); yyerrok;}
| VAR CONSTANT var2_init_decl_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed constant function variable(s) declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| var2_init_decl error
	{$$ = new var2_init_decl_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at end of function variable(s) declaration."); yyerrok;}
| var2_init_decl_list var2_init_decl error
	{$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at end of function variable(s) declaration."); yyerrok;}
| var2_init_decl_list error ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid function variable(s) declaration."); yyerrok;}
| var2_init_decl_list ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after function variable(s) declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
| FUNCTION_BLOCK io_OR_other_var_declarations_list function_block_body END_FUNCTION_BLOCK
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no function block name defined in function block declaration."); parser_state.syntax_errors++;}
| FUNCTION_BLOCK error io_OR_other_var_declarations_list function_block_body END_FUNCTION_BLOCK
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid function block name in function block declaration."); yyerrok;}
| FUNCTION_BLOCK derived_function_block_name function_block_body END_FUNCTION_BLOCK
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable(s) declared in function declaration."); parser_state.syntax_errors++;}
| FUNCTION_BLOCK derived_function_block_name io_OR_other_var_declarations_list END_FUNCTION_BLOCK
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "no body defined in function block declaration."); parser_state.syntax_errors++;}
...
| FUNCTION_BLOCK derived_function_block_name END_FUNCTION_BLOCK
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable(s) declared and body defined in function block declaration."); parser_state.syntax_errors++;}
*/
| FUNCTION_BLOCK derived_function_block_name io_OR_other_var_declarations_list function_block_body END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "expecting END_FUNCTION_BLOCK before end of file."); parser_state.syntax_errors++;}
| FUNCTION_BLOCK error END_FUNCTION_BLOCK
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in function block declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| io_OR_other_var_declarations_list located_var_declarations
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected located variable(s) declaration in function block declaration."); parser_state.syntax_errors++;}
| io_OR_other_var_declarations_list global_var_declarations
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected global variable(s) declaration in function block declaration."); parser_state.syntax_errors++;}
/*| io_OR_other_var_declarations_list access_declarations
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected access variable(s) declaration in function block declaration."); parser_state.syntax_errors++;}*/
| io_OR_other_var_declarations_list instance_specific_initializations
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected instance specific initialization(s) in function block declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| VAR_TEMP END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no variable declared in temporary variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_TEMP temp_var_decls_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "unclosed temporary variable(s) declaration."); yyerrok;}
| VAR_TEMP error temp_var_decls_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'VAR_TEMP' in function variable(s) declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| error ';'
	{$$ = new temp_var_decls_list_c(locloc(@$)); print_err_msg(parser_state, locf(@1), locl(@1), "invalid temporary variable(s) declaration."); yyerrok;}
| temp_var_decl error
	{$$ = new temp_var_decls_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at end of temporary variable(s) declaration."); yyerrok;}
| temp_var_decls_list temp_var_decl error
	{$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at end of temporary variable(s) declaration."); yyerrok;}
| temp_var_decls_list error ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid temporary variable(s) declaration."); yyerrok;}
| temp_var_decls_list ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after temporary variable(s) declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
| VAR NON_RETAIN var_init_decl_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unclosed non-retentive temporary variable(s) declaration."); yyerrok;}
| VAR NON_RETAIN error var_init_decl_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'NON_RETAIN' in non-retentive temporary variable(s) declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| PROGRAM program_var_declarations_list function_block_body END_PROGRAM
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no program name defined in program declaration.");}
| PROGRAM error program_var_declarations_list function_block_body END_PROGRAM
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid program name in program declaration."); yyerrok;}
| PROGRAM prev_declared_program_type_name function_block_body END_PROGRAM
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable(s) declared in program declaration."); parser_state.syntax_errors++;}
| PROGRAM prev_declared_program_type_name program_var_declarations_list END_PROGRAM
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "no body defined in program declaration."); parser_state.syntax_errors++;}
/*  Rule already covered by the rule to handle the preparse state!
| PROGRAM prev_declared_program_type_name END_PROGRAM
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no variable(s) declared and body defined in program declaration."); parser_state.syntax_errors++;}
*/
| PROGRAM prev_declared_program_type_name program_var_declarations_list function_block_body END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed program declaration."); parser_state.syntax_errors++;}
| PROGRAM error END_PROGRAM
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in program declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| sfc_network error
	{$$ = $1; print_err_msg(parser_state, locl(@1), locf(@2), "unexpected token after SFC network in sequencial function chart."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| INITIAL_STEP ':' action_association_list END_STEP
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "no step name defined in initial step declaration."); parser_state.syntax_errors++;}
| INITIAL_STEP error ':' action_association_list END_STEP
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid step name defined in initial step declaration."); yyerrok;}
| INITIAL_STEP step_name action_association_list END_STEP
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "':' missing after step name in initial step declaration."); parser_state.syntax_errors++;}
| INITIAL_STEP step_name ':' error END_STEP
	{$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid action association list in initial step declaration."); yyerrok;}
| INITIAL_STEP step_name ':' action_association_list END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@3), "unclosed initial step declaration."); parser_state.syntax_errors++;}
| INITIAL_STEP error END_STEP
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in initial step declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| STEP ':' action_association_list END_STEP
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no step name defined in step declaration."); parser_state.syntax_errors++;}
| STEP error ':' action_association_list END_STEP
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid step name defined in step declaration."); yyerrok;}
| STEP step_name action_association_list END_STEP
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "':' missing after step name in step declaration."); parser_state.syntax_errors++;}
| STEP step_name ':' error END_STEP
	{$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid action association list in step declaration."); yyerrok;}
| STEP step_name ':' action_association_list END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@3), "invalid action association list in step declaration."); parser_state.syntax_errors++;}
| STEP error END_STEP
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in step declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| action_association_list action_association error
	{$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at end of action association declaration."); yyerrok;}
| action_association_list ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after action association declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
action_association:
  action_name '(' {cmd_goto_sfc_qualifier_state(parser_state);} action_qualifier {cmd_pop_state(parser_state);} indicator_name_list ')'
	{$$ = new action_association_c($1, $4, $6, locloc(@$));}
/* ERROR_CHECK_BEGIN */
/*| action_name '(' error ')'
  {$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid qualifier defined in action association."); yyerrok;}*/
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| indicator_name_list indicator_name
	{$$ = $1; print_err_msg(parser_state, locl(@1), locf(@2), "',' missing at end of action association declaration."); parser_state.syntax_errors++;}
| indicator_name_list ',' error
	{$$ = $1;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no indicator defined in indicator list.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid indicator in indicator list."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| timed_qualifier action_time
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "',' missing between timed qualifier and action time in action qualifier."); parser_state.syntax_errors++;}
| timed_qualifier ',' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no action time defined in action qualifier.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid action time in action qualifier."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
qualifier:
  N		{$$ = new qualifier_c(matiec::retain_ast_string(parser_state, "N"), locloc(@$));}
| R		{$$ = new qualifier_c(matiec::retain_ast_string(parser_state, "R"), locloc(@$));}
| S		{$$ = new qualifier_c(matiec::retain_ast_string(parser_state, "S"), locloc(@$));}
| P		{$$ = new qualifier_c(matiec::retain_ast_string(parser_state, "P"), locloc(@$));}
| P0	{$$ = new qualifier_c(matiec::retain_ast_string(parser_state, "P0"), locloc(@$));}
| P1	{$$ = new qualifier_c(matiec::retain_ast_string(parser_state, "P1"), locloc(@$));}
;

timed_qualifier:
  L		{$$ = new timed_qualifier_c(matiec::retain_ast_string(parser_state, "L"), locloc(@$));}
| D		{$$ = new timed_qualifier_c(matiec::retain_ast_string(parser_state, "D"), locloc(@$));}
| SD		{$$ = new timed_qualifier_c(matiec::retain_ast_string(parser_state, "SD"), locloc(@$));}
| DS		{$$ = new timed_qualifier_c(matiec::retain_ast_string(parser_state, "DS"), locloc(@$));}
| SL		{$$ = new timed_qualifier_c(matiec::retain_ast_string(parser_state, "SL"), locloc(@$));}
;
...
| '(' step_name_list error
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "expecting ')' at the end of step list in transition declaration."); yyerrok;}
| '(' error ')'
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid step list in transition declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| step_name_list step_name
	{$$ = $1; print_err_msg(parser_state, locl(@1), locf(@2), "',' missing in step list."); parser_state.syntax_errors++;}
| step_name_list ',' error
	{$$ = $1;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no step name defined in step list.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid step name in step list."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
transition:
  TRANSITION transition_priority
    FROM steps TO steps
    {cmd_goto_body_state(parser_state);} transition_condition
  END_TRANSITION
...
/* ERROR_CHECK_BEGIN */
| TRANSITION error transition_priority FROM steps TO steps {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid transition name defined in transition declaration."); yyerrok;}
| TRANSITION transition_name error FROM steps TO steps {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid transition priority defined in transition declaration."); yyerrok;}
| TRANSITION transition_priority FROM TO steps {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "no origin step(s) defined in transition declaration."); parser_state.syntax_errors++;}
| TRANSITION transition_name transition_priority FROM TO steps {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locl(@4), locf(@5), "no origin step(s) defined in transition declaration."); parser_state.syntax_errors++;}
| TRANSITION transition_priority FROM error TO steps {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid origin step(s) defined in transition declaration."); yyerrok;}
| TRANSITION transition_name transition_priority FROM error TO steps {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locf(@5), locl(@5), "invalid origin step(s) defined in transition declaration."); yyerrok;}
| TRANSITION transition_priority FROM steps steps {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locl(@4), locf(@5), "'TO' missing between origin step(s) and destination step(s) in transition declaration."); parser_state.syntax_errors++;}
| TRANSITION transition_name transition_priority FROM steps steps {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locl(@5), locf(@6), "'TO' missing between origin step(s) and destination step(s) in transition declaration."); parser_state.syntax_errors++;}
| TRANSITION transition_priority FROM steps TO {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locl(@5), locf(@7), "no destination step(s) defined in transition declaration."); parser_state.syntax_errors++;}
| TRANSITION transition_name transition_priority FROM steps TO {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locl(@6), locf(@8), "no destination step(s) defined in transition declaration."); parser_state.syntax_errors++;}
| TRANSITION transition_priority FROM steps TO error {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locf(@6), locl(@6), "invalid destination step(s) defined in transition declaration."); yyerrok;}
| TRANSITION transition_name transition_priority FROM steps TO error {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locf(@7), locl(@7), "invalid destination step(s) defined in transition declaration."); yyerrok;}
| TRANSITION transition_priority {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@4), "no origin and destination step(s) defined in transition declaration."); parser_state.syntax_errors++;}
| TRANSITION transition_name transition_priority {cmd_goto_body_state(parser_state);} transition_condition END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@5), "no origin and destination step(s) defined in transition declaration."); parser_state.syntax_errors++;}
/*| TRANSITION transition_priority FROM steps TO steps {cmd_goto_body_state(parser_state);} transition_condition error END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@6), "unclosed transition declaration."); yyerrok;}
| TRANSITION transition_name transition_priority FROM steps TO steps {cmd_goto_body_state(parser_state);} transition_condition error END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@7), "unclosed transition declaration."); yyerrok;}*/
| TRANSITION error END_TRANSITION
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in transition declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
transition_priority:
  /* empty */
  {$$ = NULL;}
| '(' {cmd_goto_sfc_priority_state(parser_state);} PRIORITY {cmd_pop_state(parser_state);} ASSIGN integer ')'
	{$$ = $6;}
/* ERROR_CHECK_BEGIN */
/* The following error checking rules have been intentionally commented out. */
/*
| '(' ASSIGN integer ')'
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'PRIORITY' missing between '(' and ':=' in transition declaration with priority."); parser_state.syntax_errors++;}
| '(' error ASSIGN integer ')'
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "expecting 'PRIORITY' between '(' and ':=' in transition declaration with priority."); yyerrok;}
*/
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| start_IL_body_token eol_list simple_instr_list
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "':' missing before IL condition in transition declaration."); parser_state.syntax_errors++;}
| start_IL_body_token ':' eol_list error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@3), locf(@4), "no instructions defined in IL condition of transition declaration.");}
	 else {print_err_msg(parser_state, locf(@4), locl(@4), "invalid instructions in IL condition of transition declaration."); yyclearin;}
	 yyerrok;
	}
| ASSIGN ';'
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no expression defined in ST condition of transition declaration."); parser_state.syntax_errors++;}
| ASSIGN error ';'
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid expression defined in ST condition of transition declaration."); yyerrok;}
| ASSIGN expression error
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "expecting ';' after expression defined in ST condition of transition declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
action:
//  ACTION identifier ':' ...
  ACTION action_name {cmd_goto_body_state(parser_state);} action_body END_ACTION
	{$$ = new action_c($2, $4, locloc(@$));}
/* ERROR_CHECK_BEGIN */
| ACTION {cmd_goto_body_state(parser_state);} action_body END_ACTION
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@3), "no action name defined in action declaration."); parser_state.syntax_errors++;}
| ACTION error {cmd_goto_body_state(parser_state);} action_body END_ACTION
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid action name defined in action declaration."); yyerrok;}
| ACTION action_name {cmd_goto_body_state(parser_state);} function_block_body END_ACTION
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@4), "':' missing after action name in action declaration."); parser_state.syntax_errors++;}
/*| ACTION action_name {cmd_goto_body_state(parser_state);} action_body END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed action declaration."); yyerrok;}*/
| ACTION error END_ACTION
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in action declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| ':' error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@1), locf(@2), "no body defined in action declaration.");}
	 else {print_err_msg(parser_state, locf(@2), locl(@2), "invalid body defined in action declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| CONFIGURATION
   ...
   optional_instance_specific_initializations
  END_CONFIGURATION
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no configuration name defined in configuration declaration."); parser_state.syntax_errors++;}
| CONFIGURATION
   global_var_declarations_list
   resource_declaration_list
   optional_access_declarations
...
| CONFIGURATION error
   ...
   optional_instance_specific_initializations
  END_CONFIGURATION
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid configuration name defined in configuration declaration."); yyerrok;}
| CONFIGURATION error
   global_var_declarations_list
   resource_declaration_list
   optional_access_declarations
...
| CONFIGURATION configuration_name
   ...
   optional_instance_specific_initializations
  END_CONFIGURATION
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "no resource(s) defined in configuration declaration."); parser_state.syntax_errors++;}
*/
| CONFIGURATION configuration_name
   global_var_declarations_list
   error
   ...
   optional_instance_specific_initializations
  END_CONFIGURATION
  {$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid resource(s) defined in configuration declaration."); yyerrok;}
/*| CONFIGURATION configuration_name
   global_var_declarations_list
   single_resource_declaration
   {variable_name_symtable.pop();
   ...
   optional_instance_specific_initializations
  END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed configuration declaration."); yyerrok;}*/
| CONFIGURATION configuration_name
   global_var_declarations_list
   resource_declaration_list
   optional_access_declarations
...
| CONFIGURATION error END_CONFIGURATION
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in configuration declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| resource_declaration_list error
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after resource declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| RESOURCE {variable_name_symtable.push();direct_variable_symtable.push();} ON resource_type_name
   ...
   single_resource_declaration
  END_RESOURCE
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@3), "no resource name defined in resource declaration."); parser_state.syntax_errors++;}
/*|	RESOURCE {variable_name_symtable.push();direct_variable_symtable.push();} resource_name ON resource_type_name
   global_var_declarations_list
   single_resource_declaration
  END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@5), "unclosed resource declaration."); yyerrok;}*/
| RESOURCE error END_RESOURCE
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in resource declaration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| task_configuration_list task_configuration error
  {$$ = $1; print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at the end of task configuration in resource declaration."); yyerrok;}
| task_configuration_list ';'
  {$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after task configuration in resource declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
| program_configuration error
  {$$ = new program_configuration_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at the end of program configuration in resource declaration."); yyerrok;}
| program_configuration_list program_configuration error
  {$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at the end of program configuration in resource declaration."); yyerrok;}
| program_configuration_list error ';'
  {$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid program configuration in resource declaration."); yyerrok;}
| program_configuration_list ';'
  {$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after program configuration in resource declaration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
// ERROR_CHECK_BEGIN //
| VAR_ACCESS END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no variable declared in access variable(s) declaration."); parser_state.syntax_errors++;}
| VAR_ACCESS error access_declaration_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'VAR_ACCESS' in access variable(s) declaration."); yyerrok;}
| VAR_ACCESS access_declaration_list error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed access variable(s) declaration."); yyerrok;}
| VAR_ACCESS error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in access variable(s) declaration."); yyerrok;}
// ERROR_CHECK_END //
;
...
| error ';'
  {$$ = new access_declaration_list_c(locloc(@$));
	 print_err_msg(parser_state, locf(@1), locl(@1), "invalid access variable declaration."); yyerrok;}
| access_declaration error
  {$$ = new access_declaration_list_c(locloc(@$)); $$->add_element($1);
	 print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at the end of access variable declaration."); yyerrok;}
| access_declaration_list access_declaration error
  {$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at the end of access variable declaration."); yyerrok;}
| access_declaration_list error ';'
  {$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid access variable declaration."); yyerrok;}
| access_declaration_list ';'
  {$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after access variable declaration."); parser_state.syntax_errors++;}
// ERROR_CHECK_END //
;
...
| TASK task_initialization
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no task name defined in task declaration."); parser_state.syntax_errors++;}
| TASK error task_initialization
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid task name defined in task declaration."); yyerrok;}
| TASK task_name error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no task initialization defined in task declaration.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid task initialization in task declaration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
//  '(' [SINGLE ASSIGN data_source ','] [INTERVAL ASSIGN data_source ','] PRIORITY ASSIGN integer ')' //
  '(' {cmd_goto_task_init_state(parser_state);} task_initialization_single task_initialization_interval task_initialization_priority ')'
...
// [SINGLE ASSIGN data_source ',']
  /* empty */
	{$$ = NULL;}
| SINGLE ASSIGN {cmd_pop_state(parser_state);} data_source ',' {cmd_goto_task_init_state(parser_state);}
	{$$ = $4;}
/* ERROR_CHECK_BEGIN */
| SINGLE {cmd_pop_state(parser_state);} data_source ',' {cmd_goto_task_init_state(parser_state);}
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@3), "':=' missing after 'SINGLE' in task initialization."); parser_state.syntax_errors++;}
| SINGLE ASSIGN {cmd_pop_state(parser_state);} ',' {cmd_goto_task_init_state(parser_state);}
  {$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@4), "no data source defined in 'SINGLE' statement of task initialization."); parser_state.syntax_errors++;}
| SINGLE ASSIGN {cmd_pop_state(parser_state);} error ',' {cmd_goto_task_init_state(parser_state);}
  {$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid data source defined in 'SINGLE' statement of task initialization."); yyerrok;}
/* ERROR_CHECK_END */
;
...
// [INTERVAL ASSIGN data_source ',']
  /* empty */
	{$$ = NULL;}
| INTERVAL ASSIGN {cmd_pop_state(parser_state);} data_source ',' {cmd_goto_task_init_state(parser_state);}
	{$$ = $4;}
/* ERROR_CHECK_BEGIN */
| INTERVAL {cmd_pop_state(parser_state);} data_source ',' {cmd_goto_task_init_state(parser_state);}
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@3), "':=' missing after 'INTERVAL' in task initialization.");}
| INTERVAL ASSIGN {cmd_pop_state(parser_state);} ',' {cmd_goto_task_init_state(parser_state);}
  {$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@4), "no data source defined in 'INTERVAL' statement of task initialization."); parser_state.syntax_errors++;}
| INTERVAL ASSIGN {cmd_pop_state(parser_state);} error ',' {cmd_goto_task_init_state(parser_state);}
  {$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid data source defined in 'INTERVAL' statement of task initialization."); yyerrok;}
/* ERROR_CHECK_END */
;
...
// PRIORITY ASSIGN integer
  PRIORITY ASSIGN {cmd_pop_state(parser_state);} integer
	{$$ = $4;}
/* ERROR_CHECK_BEGIN */
| PRIORITY {cmd_pop_state(parser_state);} integer
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@3), "':=' missing after 'PRIORITY' in task initialization."); parser_state.syntax_errors++;}
| PRIORITY ASSIGN {cmd_pop_state(parser_state);} error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@4), "no priority number defined in 'PRIORITY' statement of task initialization.");}
	 else {print_err_msg(parser_state, locf(@4), locl(@4), "invalid priority number in 'PRIORITY' statement of task initialization."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| PROGRAM program_name optional_task_name ':' identifier optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locf(@5), locl(@5), "invalid program type name after ':' in program configuration."); parser_state.syntax_errors++;}
| PROGRAM RETAIN program_name optional_task_name ':' identifier optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locf(@6), locl(@6), "invalid program type name after ':' in program configuration."); parser_state.syntax_errors++;}
...
| PROGRAM error program_name optional_task_name ':' prev_declared_program_type_name optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'PROGRAM' in program configuration."); yyerrok;}
| PROGRAM RETAIN error program_name optional_task_name ':' prev_declared_program_type_name optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'RETAIN' in retentive program configuration."); yyerrok;}
| PROGRAM NON_RETAIN error program_name optional_task_name ':' prev_declared_program_type_name optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "unexpected token after 'NON_RETAIN' in non-retentive program configuration."); yyerrok;}
| PROGRAM optional_task_name ':' prev_declared_program_type_name optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no program name defined in program configuration."); parser_state.syntax_errors++;}
| PROGRAM RETAIN optional_task_name ':' prev_declared_program_type_name optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no program name defined in retentive program configuration."); parser_state.syntax_errors++;}
| PROGRAM NON_RETAIN optional_task_name ':' prev_declared_program_type_name optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no program name defined in non-retentive program configuration."); parser_state.syntax_errors++;}
| PROGRAM error optional_task_name ':' prev_declared_program_type_name optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid program name defined in program configuration."); yyerrok;}
| PROGRAM RETAIN error optional_task_name ':' prev_declared_program_type_name optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid program name defined in retentive program configuration."); yyerrok;}
| PROGRAM NON_RETAIN error optional_task_name ':' prev_declared_program_type_name optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid program name defined in non-retentive program configuration."); yyerrok;}
| PROGRAM program_name optional_task_name prev_declared_program_type_name optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "':' missing after program name or optional task name in program configuration."); parser_state.syntax_errors++;}
| PROGRAM RETAIN program_name optional_task_name prev_declared_program_type_name optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locl(@4), locf(@5), "':' missing after program name or optional task name in retentive program configuration."); parser_state.syntax_errors++;}
| PROGRAM NON_RETAIN program_name optional_task_name prev_declared_program_type_name optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locl(@4), locf(@5), "':' missing after program name or optional task name in non-retentive program configuration."); parser_state.syntax_errors++;}
| PROGRAM program_name optional_task_name ':' optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locl(@4), locf(@5), "no program type defined in program configuration."); parser_state.syntax_errors++;}
| PROGRAM RETAIN program_name optional_task_name ':' optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locl(@5), locf(@6), "no program type defined in retentive program configuration."); parser_state.syntax_errors++;}
| PROGRAM NON_RETAIN program_name optional_task_name ':' optional_prog_conf_elements
  {$$ = NULL; print_err_msg(parser_state, locl(@5), locf(@6), "no program type defined in non-retentive program configuration."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
| WITH error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@1), locf(@2), "no task name defined in optional task name of program configuration.");}
	 else {print_err_msg(parser_state, locf(@2), locl(@2), "invalid task name in optional task name of program configuration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| '(' error ')'
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid program configuration elements in program configuration."); yyerrok;}
| '(' prog_conf_elements error
  {$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "')' missing at the end of program configuration elements in program configuration."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| prog_conf_elements prog_conf_element
  {$$ = $1; print_err_msg(parser_state, locl(@1), locf(@2), "',' missing in program configuration elements list."); parser_state.syntax_errors++;}
| prog_conf_elements ',' error
  {$$ = $1;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no value defined for program configuration element in program configuration list.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid value for program configuration element in program configuration list."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| any_identifier WITH error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no task name defined in function block configuration.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid task name in function block configuration."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| any_symbolic_variable constant
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' missing between parameter and value in program configuration element."); parser_state.syntax_errors++;}
| any_symbolic_variable enumerated_value
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' missing between parameter and value in program configuration element."); parser_state.syntax_errors++;}
| any_symbolic_variable data_sink
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' or '=>' missing between parameter and variable in program configuration element."); parser_state.syntax_errors++;}
| any_symbolic_variable ASSIGN error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no value or variable defined in program configuration assignment element.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid value or variable in program configuration assignment element."); yyclearin;}
	 yyerrok;
	}
| any_symbolic_variable SENDTO error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no variable defined in program configuration sendto element.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid variable in program configuration sendto element."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| VAR_CONFIG END_VAR
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no variable declared in configuration variable(s) initialization."); parser_state.syntax_errors++;}
| VAR_CONFIG error instance_specific_init_list END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected token after 'VAR_CONFIG' in configuration variable(s) initialization."); yyerrok;}
| VAR_CONFIG instance_specific_init_list error END_OF_INPUT
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed configuration variable(s) initialization."); yyerrok;}
| VAR_CONFIG error END_VAR
	{$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in configuration variable(s) initialization."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| error ';'
  {$$ = new instance_specific_init_list_c(locloc(@$)); print_err_msg(parser_state, locf(@1), locl(@1), "invalid configuration variable initialization."); yyerrok;}
| instance_specific_init error
  {$$ = new instance_specific_init_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at the end of configuration variable initialization."); yyerrok;}
| instance_specific_init_list instance_specific_init error
  {$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at the end of configuration variable initialization."); yyerrok;}
| instance_specific_init_list error ';'
  {$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid configuration variable initialization."); yyerrok;}
| instance_specific_init_list ';'
  {$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after configuration variable initialization."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
| function_block_type_name structure_initialization
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':=' missing between function block name and initialization in function block initialization."); parser_state.syntax_errors++;}
| function_block_type_name ASSIGN error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no initial value defined in function block initialization.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid initial value in function block initialization."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| error eol_list
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "invalid IL instruction."); yyerrok;}
| il_incomplete_instruction error
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "EOL missing at the end of IL instruction."); yyerrok;}
| error ':' il_incomplete_instruction eol_list
	{$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "invalid label in IL instruction."); yyerrok;}
| label il_incomplete_instruction eol_list
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing after label in IL instruction."); parser_state.syntax_errors++;}
| label ':' error eol_list
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid IL instruction."); yyerrok;}
| label ':' il_incomplete_instruction error
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "EOL missing at the end of IL instruction."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| il_simple_operator_clash il_operand_list2
	{$$ = new il_function_call_c(il_operator_c_2_poutype_identifier_c(parser_state, $1), $2, locloc(@$));}
;
...
| il_expr_operator_noclash '(' eol_list error
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "')' missing at the end of IL expression."); yyerrok;}
| il_expr_operator_noclash '(' il_operand eol_list error
  {$$ = NULL; print_err_msg(parser_state, locl(@4), locf(@5), "')' missing at the end of IL expression."); yyerrok;}
...
| il_expr_operator_noclash '(' il_operand eol_list simple_instr_list error
  {$$ = NULL; print_err_msg(parser_state, locl(@5), locf(@6), "')' missing at the end of IL expression."); yyerrok;}
...
| il_expr_operator_clash_eol_list simple_instr_list error
  {$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "')' missing at the end of IL expression."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| il_jump_operator error
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid label defined in IL jump operation."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| il_call_operator error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@1), locf(@2), "no function block name defined in IL function block call.");}
	 else {print_err_msg(parser_state, locf(@2), locl(@2), "invalid function block name in IL function block call."); yyclearin;}
	 yyerrok;
	}
| il_call_operator '(' ')'
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no function block name defined in IL function block call."); parser_state.syntax_errors++;}
...
| il_call_operator '(' eol_list il_param_list ')'
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no function block name defined in IL function block call."); parser_state.syntax_errors++;}
| il_call_operator error '(' ')'
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid function block name defined in IL function block call."); yyerrok;}
...
| il_call_operator error '(' eol_list il_param_list ')'
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid function block name defined in IL function block call."); yyerrok;}
| il_call_operator prev_declared_fb_name ')'
  {$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "'(' missing after function block name defined in IL function block call."); parser_state.syntax_errors++;}
| il_call_operator prev_declared_fb_name il_operand_list ')'
  {$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "'(' missing after function block name defined in IL function block call."); parser_state.syntax_errors++;}
| il_call_operator prev_declared_fb_name '(' error
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "')' missing at the end of IL function block call."); yyerrok;}
| il_call_operator prev_declared_fb_name '(' eol_list error
  {$$ = NULL; print_err_msg(parser_state, locl(@4), locf(@5), "')' missing at the end of IL function block call."); yyerrok;}
...
| il_expr_operator_clash_eol_list il_param_list ')'
	{$$ = new il_formal_funct_call_c(il_operator_c_2_poutype_identifier_c(parser_state, $1), $2, locloc(@$));}
/* ERROR_CHECK_BEGIN */
| function_name_no_clashes '(' eol_list error ')'
  {$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid parameter list defined in IL formal function call."); yyerrok;}
| function_name_simpleop_clashes '(' eol_list error ')'
  {$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid parameter list defined in IL formal function call."); yyerrok;}
| il_expr_operator_clash_eol_list error ')'
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid parameter list defined in IL formal function call."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| il_expr_operator_clash '(' error
  {$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "EOL missing after '(' in IL instruction."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| il_operand_list2 il_operand
  {$$ = $1; print_err_msg(parser_state, locl(@1), locf(@2), "',' missing in IL operand list."); parser_state.syntax_errors++;}
| il_operand ',' error
  {$$ = new il_operand_list_c(locloc(@$));
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no operand defined in IL operand list.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid operand name in IL operand list."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| il_expression error
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "EOL missing after expression IL instruction."); yyerrok;}
| il_formal_funct_call error
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "EOL missing after formal function call IL instruction."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| il_param_instruction_list error
  {$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid parameter assignment in parameter assignment list."); yyerrok;}
| il_param_last_instruction il_param_last_instruction
  {$$ = new il_param_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "',' missing at the end of parameter assignment in parameter assignment list."); parser_state.syntax_errors++;}
| il_param_instruction_list il_param_last_instruction il_param_last_instruction
  {$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "',' missing at the end of parameter assignment in parameter assignment list."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
| il_param_assignment ',' error
  {$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "EOL missing at the end of parameter assignment in parameter assignment list."); yyerrok;}
| il_param_out_assignment ',' error
  {$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "EOL missing at the end of parameter out assignment in parameter assignment list."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| il_param_assignment error
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "EOL missing at the end of last parameter assignment in parameter assignment list."); yyerrok;}
| il_param_out_assignment error
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "EOL missing at the end of last parameter out assignment in parameter assignment list."); yyerrok;}
/* ERROR_CHECK_END */
...
/* ERROR_CHECK_BEGIN */
| error il_operand
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "invalid operator in parameter assignment."); yyerrok;}
| error '(' eol_list simple_instr_list ')'
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "invalid operator in parameter assignment."); yyerrok;}
| il_assign_operator error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@1), locf(@2), "no operand defined in parameter assignment.");}
	 else {print_err_msg(parser_state, locf(@2), locl(@2), "invalid operand in parameter assignment."); yyclearin;}
	 yyerrok;
	}
| il_assign_operator '(' eol_list ')'
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "no instruction list defined in parameter assignment."); parser_state.syntax_errors++;}
| il_assign_operator '(' eol_list error ')'
  {$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid instruction list defined in parameter assignment."); yyerrok;}
| il_assign_operator '(' eol_list simple_instr_list error
  {$$ = NULL; print_err_msg(parser_state, locl(@4), locf(@5), "')' missing at the end of instruction list defined in parameter assignment."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| il_assign_out_operator error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@1), locf(@2), "no variable defined in IL operand list.");}
	 else {print_err_msg(parser_state, locf(@2), locl(@2), "invalid variable in IL operand list."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| en_identifier ASSIGN
	{$$ = new il_assign_operator_c($1, locloc(@$));}
| S1_operator ASSIGN
	{$$ = new il_assign_operator_c(il_operator_c_2_identifier_c(parser_state, $1), locloc(@$));}
| R1_operator ASSIGN
	{$$ = new il_assign_operator_c(il_operator_c_2_identifier_c(parser_state, $1), locloc(@$));}
| CLK_operator ASSIGN
	{$$ = new il_assign_operator_c(il_operator_c_2_identifier_c(parser_state, $1), locloc(@$));}
...
/* ERROR_CHECK_BEGIN */
| error ASSIGN
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "invalid parameter defined in parameter assignment."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| error SENDTO
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "invalid parameter defined in parameter out assignment."); yyerrok;}
| NOT SENDTO
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no parameter defined in parameter out assignment."); parser_state.syntax_errors++;}
| NOT error SENDTO
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid parameter defined in parameter out assignment."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| expression OR error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no expression defined after 'OR' in ST expression.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid expression after 'OR' in ST expression."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| xor_expression XOR error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no expression defined after 'XOR' in ST expression.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid expression after 'XOR' in ST expression."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| and_expression '&' error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no expression defined after '&' in ST expression.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid expression after '&' in ST expression."); yyclearin;}
	 yyerrok;
	}
| and_expression AND error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no expression defined after 'AND' in ST expression.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid expression after 'AND' in ST expression."); yyclearin;}
	 yyerrok;
	}
...
| term MOD error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no expression defined after 'MOD' in ST expression.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid expression after 'MOD' in ST expression."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| '-' error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@1), locf(@2), "no expression defined after '-' in ST expression.");}
	 else {print_err_msg(parser_state, locf(@2), locl(@2), "invalid expression after '-' in ST expression."); yyclearin;}
	 yyerrok;
	}
| NOT error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@1), locf(@2), "no expression defined after 'NOT' in ST expression.");}
	 else {print_err_msg(parser_state, locf(@2), locl(@2), "invalid expression after 'NOT' in ST expression."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| '(' expression error
  {$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "')' missing at the end of expression in ST expression."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| function_name_no_NOT_clashes '(' ')'
	{if (NULL == dynamic_cast<poutype_identifier_c*>($1)) ERROR; // $1 should be a poutype_identifier_c
	 if (parser_state.options.allow_missing_var_in)
		{$$ = new function_invocation_c($1, NULL, NULL, locloc(@$));}
	 else
		{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "no parameter defined in function invocation of ST expression."); parser_state.syntax_errors++;}
	}
| symbolic_variable METHOD_DOT method_identifier_token '(' param_assignment_formal_list ')'
	{$$ = new object_method_invocation_c($1, new identifier_c($3, locloc(@3)), $5, NULL, locloc(@$));
	 if (!parser_state.options.iec2025_experimental) {
	   print_err_msg(parser_state, locf(@1), locl(@6), "method invocation requires --std=iec61131-3:2025-experimental.");
	   parser_state.syntax_errors++;
	 }}
...
| symbolic_variable METHOD_DOT method_identifier_token '(' ')'
	{$$ = new object_method_invocation_c($1, new identifier_c($3, locloc(@3)), NULL, NULL, locloc(@$));
	 if (!parser_state.options.iec2025_experimental) {
	   print_err_msg(parser_state, locf(@1), locl(@5), "method invocation requires --std=iec61131-3:2025-experimental.");
	   parser_state.syntax_errors++;
	 }}
/* ERROR_CHECK_BEGIN */
| function_name_no_NOT_clashes param_assignment_formal_list ')'
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'(' missing after function name in ST expression."); parser_state.syntax_errors++;}
| function_name_no_NOT_clashes '(' error ')'
  {$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid parameter(s) defined in function invocation of ST expression."); yyerrok;}
| function_name_no_NOT_clashes '(' param_assignment_formal_list error
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "')' missing at the end of function invocation in ST expression."); yyerrok;}
...
/* ERROR_CHECK_BEGIN */
| statement error
	{$$ = new statement_list_c(locloc(@$)); print_err_msg(parser_state, locl(@1), locf(@2), "';' missing at the end of statement in ST statement."); yyerrok;}
| statement_list statement error
	{$$ = $1; print_err_msg(parser_state, locl(@2), locf(@3), "';' missing at the end of statement in ST statement."); yyerrok;}
| statement_list error ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "invalid statement in ST statement."); yyerrok;}
| statement_list ';'
	{$$ = $1; print_err_msg(parser_state, locf(@2), locl(@2), "unexpected ';' after statement in ST statement."); parser_state.syntax_errors++;}
/* ERROR_CHECK_END */
;
...
| function_invocation
	{ /* This is a non-standard extension (calling a function outside an ST expression!) */
	  ...
	  $$ = $1;
	  if (!parser_state.options.allow_void_datatype &&
	      !is_profile_assert_invocation(parser_state, $1)) {
	    print_err_msg(parser_state, locf(@1), locl(@1), "Function invocation in ST code is not allowed outside an expression. To allow this non-standard syntax, activate the apropriate command line option.");
	    parser_state.syntax_errors++;
	  }
	}
;
...
| error ASSIGN expression
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "invalid variable before ':=' in ST assignment statement."); yyerrok;}
| variable ASSIGN error
	{$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no expression defined after ':=' in ST assignment statement.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid expression after ':=' in ST assignment statement."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| prev_declared_fb_name ')'
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'(' missing after function block name in ST statement."); parser_state.syntax_errors++;}
| prev_declared_fb_name param_assignment_formal_list ')'
	{$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "'(' missing after function block name in ST statement."); parser_state.syntax_errors++;}
| prev_declared_fb_name '(' error ')'
	{$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid parameter list in function block invocation in ST statement."); yyerrok;}
| prev_declared_fb_name '(' error
	{$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "')' missing after parameter list of function block invocation in ST statement."); yyerrok;}
| prev_declared_fb_name '(' param_assignment_formal_list error
	{$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "')' missing after parameter list of function block invocation in ST statement."); yyerrok;}
...
| param_assignment_formal_list ',' error
  {$$ = $1;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no parameter assignment defined in ST parameter assignment list.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid parameter assignment in ST parameter assignment list."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| any_identifier ASSIGN error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no expression defined in ST formal parameter assignment.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid expression in ST formal parameter assignment."); yyclearin;}
	 yyerrok;
	}
...
| sendto_identifier SENDTO error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no expression defined in ST formal parameter out assignment.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid expression in ST formal parameter out assignment."); yyclearin;}
	 yyerrok;
	}
/*
...
*/
| NOT SENDTO variable
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no parameter name defined in ST formal parameter out negated assignment."); parser_state.syntax_errors++;}
| NOT error SENDTO variable
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid parameter name defined in ST formal parameter out negated assignment."); yyerrok;}
| NOT sendto_identifier SENDTO error
  {$$ = NULL;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@3), locf(@4), "no expression defined in ST formal parameter out negated assignment.");}
	 else {print_err_msg(parser_state, locf(@4), locl(@4), "invalid expression in ST formal parameter out negated assignment."); yyclearin;}
	 yyerrok;
	}
/*
...
| IF THEN statement_list elseif_statement_list END_IF
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no test expression defined in ST 'IF' statement."); parser_state.syntax_errors++;}
...
| IF error THEN statement_list elseif_statement_list END_IF
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid test expression defined for ST 'IF' statement."); yyerrok;}
...
| IF expression error statement_list elseif_statement_list END_IF
  {$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "expecting 'THEN' after test expression in ST 'IF' statement."); yyerrok;}
...
| IF expression THEN elseif_statement_list END_IF
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "no statement defined after 'THEN' in ST 'IF' statement."); parser_state.syntax_errors++;}
...
| IF expression THEN statement_list elseif_statement_list ELSE END_IF
  {$$ = NULL; print_err_msg(parser_state, locl(@6), locf(@7), "no statement defined after 'ELSE' in ST 'IF' statement."); parser_state.syntax_errors++;}
| IF expression THEN statement_list elseif_statement_list ELSE error END_IF
  {$$ = NULL; print_err_msg(parser_state, locf(@7), locl(@7), "invalid statement defined after 'ELSE' in ST 'IF' statement."); parser_state.syntax_errors++; yyerrok;}
| IF expression error END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed 'IF' statement in ST."); yyerrok;}
| IF expression THEN statement_list elseif_statement_list END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@3), "unclosed 'IF' statement in ST."); parser_state.syntax_errors++;}
| IF expression THEN statement_list elseif_statement_list ELSE statement_list END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@3), "unclosed 'IF' statement in ST."); parser_state.syntax_errors++;}
| IF error END_IF
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in ST 'IF' statement."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| ELSIF THEN statement_list
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no test expression defined for 'ELSEIF' statement in ST 'IF' statement."); parser_state.syntax_errors++;}
| ELSIF error THEN statement_list
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid test expression defined for 'ELSEIF' statement in ST 'IF' statement."); yyerrok;}
| ELSIF expression error statement_list
  {$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "expecting 'THEN' after test expression in 'ELSEIF' statement of ST 'IF' statement."); yyerrok;}
| ELSIF expression THEN error
  {$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid statement list in 'ELSEIF' statement of ST 'IF' statement."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| CASE OF case_element_list END_CASE
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no test expression defined in ST 'CASE' statement."); parser_state.syntax_errors++;}
| CASE OF case_element_list ELSE statement_list END_CASE
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no test expression defined in ST 'CASE' statement."); parser_state.syntax_errors++;}
| CASE error OF case_element_list END_CASE
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid test expression defined for ST 'CASE' statement."); yyerrok;}
| CASE error OF case_element_list ELSE statement_list END_CASE
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid test expression defined for ST 'CASE' statement."); yyerrok;}
| CASE expression error case_element_list END_CASE
  {$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "expecting 'OF' after test expression in ST 'CASE' statement."); yyerrok;}
| CASE expression error case_element_list ELSE statement_list END_CASE
  {$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "expecting 'OF' after test expression in ST 'CASE' statement."); yyerrok;}
| CASE expression OF END_CASE
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "no case element(s) defined after 'OF' in ST 'CASE' statement."); parser_state.syntax_errors++;}
| CASE expression OF ELSE statement_list END_CASE
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "no case element(s) defined after 'OF' in ST 'CASE' statement."); parser_state.syntax_errors++;}
| CASE expression OF error END_CASE
  {$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid case element(s) defined after 'OF' in ST 'CASE' statement."); yyerrok;}
| CASE expression OF error ELSE statement_list END_CASE
  {$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid case element(s) defined after 'OF' in ST 'CASE' statement."); yyerrok;}
| CASE expression OF case_element_list ELSE END_CASE
  {$$ = NULL; print_err_msg(parser_state, locl(@5), locf(@6), "no statement defined after 'ELSE' in ST 'CASE' statement."); parser_state.syntax_errors++;}
| CASE expression OF case_element_list ELSE error END_CASE
  {$$ = NULL; print_err_msg(parser_state, locf(@6), locl(@6), "invalid statement defined after 'ELSE' in ST 'CASE' statement."); yyerrok;}
| CASE expression error END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@2), "unclosed 'CASE' statement in ST."); yyerrok;}
| CASE expression OF case_element_list END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@3), "unclosed 'CASE' statement in ST."); parser_state.syntax_errors++;}
| CASE expression OF case_element_list ELSE statement_list END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@3), "unclosed 'CASE' statement in ST."); parser_state.syntax_errors++;}
| CASE error END_CASE
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in ST 'CASE' statement."); yyerrok;}
/* ERROR_CHECK_END */
;
...
/* ERROR_CHECK_BEGIN */
| case_list statement_list
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "':' missing after case list in ST 'CASE' statement."); parser_state.syntax_errors++;}
| case_list ':' error
  {$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "invalid statement in case element of ST 'CASE' statement."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| case_list ',' error
  {$$ = $1;
	 if (is_current_syntax_token()) {print_err_msg(parser_state, locl(@2), locf(@3), "no case defined in case list of ST parameter assignment list.");}
	 else {print_err_msg(parser_state, locf(@3), locl(@3), "invalid case in case list of ST parameter assignment list."); yyclearin;}
	 yyerrok;
	}
/* ERROR_CHECK_END */
;
...
| FOR ASSIGN expression TO expression BY expression DO statement_list END_FOR
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no control variable defined in ST 'FOR' statement."); parser_state.syntax_errors++;}
...
| FOR error ASSIGN expression TO expression BY expression DO statement_list END_FOR
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid control variable defined for ST 'FOR' statement."); yyerrok;}
...
| FOR control_variable expression TO expression BY expression DO statement_list END_FOR
  {$$ = NULL; print_err_msg(parser_state, locl(@2), locf(@3), "':=' missing between control variable and start expression in ST 'FOR' statement."); parser_state.syntax_errors++;}
...
| FOR control_variable error expression TO expression BY expression DO statement_list END_FOR
  {$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "expecting ':=' between control variable and start expression in ST 'FOR' statement."); yyerrok;}
...
| FOR control_variable ASSIGN TO expression BY expression DO statement_list END_FOR
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "no start expression defined in ST 'FOR' statement."); parser_state.syntax_errors++;}
...
| FOR control_variable ASSIGN error TO expression BY expression DO statement_list END_FOR
  {$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid start expression defined in ST 'FOR' statement."); yyerrok;}
| FOR control_variable ASSIGN error TO expression DO statement_list END_FOR
  {$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid start expression in ST 'FOR' statement."); yyerrok;}
| FOR control_variable ASSIGN expression error expression BY expression DO statement_list END_FOR
  {$$ = NULL; print_err_msg(parser_state, locf(@5), locl(@5), "expecting 'TO' between start expression and end expression in ST 'FOR' statement."); yyerrok;}
...
| FOR control_variable ASSIGN expression TO expression error expression DO statement_list END_FOR
  {$$ = NULL; print_err_msg(parser_state, locf(@7), locl(@7), "expecting 'BY' between end expression and step expression in ST 'FOR' statement."); yyerrok;}
| FOR control_variable ASSIGN expression TO expression BY expression error statement_list END_FOR
  {$$ = NULL; print_err_msg(parser_state, locf(@9), locl(@9), "expecting 'DO' after step expression in ST 'FOR' statement."); yyerrok;}
| FOR control_variable ASSIGN expression TO expression error statement_list END_FOR
  {$$ = NULL; print_err_msg(parser_state, locf(@7), locl(@7), "expecting 'DO' after end expression in ST 'FOR' statement."); yyerrok;}
| FOR control_variable ASSIGN expression TO expression BY expression DO END_FOR
  {$$ = NULL; print_err_msg(parser_state, locl(@9), locf(@10), "no statement(s) defined after 'DO' in ST 'FOR' statement."); parser_state.syntax_errors++;}
| FOR control_variable ASSIGN expression TO expression DO END_FOR
  {$$ = NULL; print_err_msg(parser_state, locl(@7), locf(@8), "no statement(s) defined after 'DO' in ST 'FOR' statement."); parser_state.syntax_errors++;}
| FOR control_variable ASSIGN expression TO expression BY expression DO error END_FOR
  {$$ = NULL; print_err_msg(parser_state, locf(@10), locl(@10), "invalid statement(s) defined after 'DO' in ST 'FOR' statement."); yyerrok;}
| FOR control_variable ASSIGN expression TO expression DO error END_FOR
  {$$ = NULL; print_err_msg(parser_state, locf(@8), locl(@8), "invalid statement(s) defined after 'DO' in ST 'FOR' statement."); yyerrok;}
| FOR control_variable error END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed 'FOR' statement in ST."); yyerrok;}
...
| FOR control_variable ASSIGN expression TO expression DO statement_list END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed 'FOR' statement in ST."); parser_state.syntax_errors++;}
...
| FOR control_variable ASSIGN expression TO expression BY expression DO statement_list END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed 'FOR' statement in ST."); parser_state.syntax_errors++;}
| FOR error END_FOR
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in ST 'FOR' statement."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| WHILE DO statement_list END_WHILE
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no test expression defined in ST 'WHILE' statement."); parser_state.syntax_errors++;}
| WHILE error DO statement_list END_WHILE
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid test expression defined for ST 'WHILE' statement."); yyerrok;}
| WHILE expression error statement_list END_WHILE
  {$$ = NULL; print_err_msg(parser_state, locf(@3), locl(@3), "expecting 'DO' after test expression in ST 'WHILE' statement."); yyerrok;}
| WHILE expression DO END_WHILE
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "no statement(s) defined after 'DO' in ST 'WHILE' statement."); parser_state.syntax_errors++;}
| WHILE expression DO error END_WHILE
  {$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid statement(s) defined after 'DO' in ST 'WHILE' statement."); yyerrok;}
| WHILE expression error END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed 'WHILE' statement in ST."); yyerrok;}
| WHILE expression DO statement_list END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed 'WHILE' statement in ST."); parser_state.syntax_errors++;}
| WHILE error END_WHILE
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in ST 'WHILE' statement."); yyerrok;}
/* ERROR_CHECK_END */
;
...
| REPEAT UNTIL expression END_REPEAT
  {$$ = NULL; print_err_msg(parser_state, locl(@1), locf(@2), "no statement(s) defined after 'REPEAT' in ST 'REPEAT' statement."); parser_state.syntax_errors++;}
| REPEAT error UNTIL expression END_REPEAT
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "invalid statement(s) defined after 'REPEAT' for ST 'REPEAT' statement."); yyerrok;}
| REPEAT statement_list UNTIL END_REPEAT
  {$$ = NULL; print_err_msg(parser_state, locl(@3), locf(@4), "no test expression defined after 'UNTIL' in ST 'REPEAT' statement.");}
| REPEAT statement_list UNTIL error END_REPEAT
  {$$ = NULL; print_err_msg(parser_state, locf(@4), locl(@4), "invalid test expression defined after 'UNTIL' in ST 'REPEAT' statement."); yyerrok;}
| REPEAT statement_list END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed 'REPEAT' statement in ST."); parser_state.syntax_errors++;}
| REPEAT statement_list UNTIL expression error END_OF_INPUT
  {$$ = NULL; print_err_msg(parser_state, locf(@1), locl(@1), "unclosed 'REPEAT' statement in ST."); yyerrok;}
| REPEAT error END_REPEAT
  {$$ = NULL; print_err_msg(parser_state, locf(@2), locl(@2), "unknown error in ST 'REPEAT' statement."); yyerrok;}
/* ERROR_CHECK_END */
;
...
void print_err_msg(const matiec::ParserState &parser_state, int first_line,
  ...
  if (parser_state.options.full_token_loc) {
...
poutype_identifier_c *il_operator_c_2_poutype_identifier_c(
    matiec::ParserState &parser_state, symbol_c *il_operator) {
  identifier_c *id = il_operator_c_2_identifier_c(parser_state, il_operator);
  poutype_identifier_c *pou_id = new poutype_identifier_c(matiec::retain_ast_string(parser_state, id->value));
...
/*
  ...
  free(il_operator);
*/
  res = new identifier_c(matiec::retain_ast_string(parser_state, name));
...
static int parse_files(matiec::ParserState &parser_state,
  ...
  */
  FILE *libfile = NULL;
  if((libfile = parse_file(parser_state, libfilename)) == NULL) {
  ...
  if ((mainfile = source == NULL
                      ? parse_file_as(parser_state, filename, display_filename)
                      : parse_source_as(parser_state, source, source_size, display_filename)) == NULL) {
...
int stage2__(matiec::ParserState &parser_state, const char *filename,
