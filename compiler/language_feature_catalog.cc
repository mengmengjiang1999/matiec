...
const std::vector<LanguageFeatureRecord> &language_feature_catalog() {
  ...
  static const std::vector<LanguageFeatureRecord> catalog = {
    ...
    {"ED3-OO", "Object-oriented elements", Family::pou, Status::partially_implemented, "iec61131-3:2025-experimental", Evidence::implementation_verified, Evidence::cross_vendor_provisional, "compiler/object_method_normalizer.cc; stage1_2/iec_bison.yy; absyntax/absyntax.def; public Edition 3 vendor material", "compiler/tests/object_method_normalizer_test.cc; tests/cli/runtests", "Native structural AST with compatibility semantic/C lowering; only public function-block methods with static dispatch are implemented; classes, interfaces, inheritance, overrides, properties, and normative 2025 behavior remain unverified", false},
