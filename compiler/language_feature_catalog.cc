...
const std::vector<LanguageFeatureRecord> &language_feature_catalog() {
  ...
  static const std::vector<LanguageFeatureRecord> catalog = {
    ...
    {"CONFIG-VAR-ACCESS", "Access variables", Family::configuration, Status::partially_implemented, "iec61131-3:2025-experimental", Evidence::implementation_verified, Evidence::cross_vendor_provisional, "compiler/access_variable_ast.cc; stage1_2/iec_bison.yy; absyntax/absyntax.def; public Beckhoff and OPC Foundation material", "tests/compiler/sequential_compilation_test.cc; tests/cli/runtests", "Native post-parse AST validation supports configuration globals, resource globals, resource program outputs, structure fields, and constant array subscripts with ACCESS.csv export; direct addresses, dynamic subscripts, runtime binding, and normative 2025 behavior remain unverified", false},
    {"ED3-NAMESPACE", "Namespaces and qualified names", Family::pou, Status::partially_implemented, "iec61131-3:2025-experimental", Evidence::implementation_verified, Evidence::cross_vendor_provisional, "compiler/parser_state.cc; compiler/namespace_ast_analysis.cc; stage1_2/iec_flex.ll; stage1_2/iec_bison.yy; absyntax/absyntax.def; public vendor material", "tests/compiler/c_api_virtual_include_test.c; tests/compiler/sequential_compilation_test.cc; tests/cli/runtests", "Native lexer/parser/AST handling supports deterministic lookup and cross-include declarations without source normalization; normative 2025 aliases, reopening, shadowing, and ABI rules remain unverified", false},
    {"ED3-OO", "Object-oriented elements", Family::pou, Status::partially_implemented, "iec61131-3:2025-experimental", Evidence::implementation_verified, Evidence::cross_vendor_provisional, "compiler/object_method_ast_analysis.cc; compiler/object_method_binding.cc; compiler/object_method_call_binding.cc; stage1_2/iec_bison.yy; absyntax/absyntax.def; public Edition 3 vendor material", "tests/compiler/c_api_virtual_include_test.c; tests/compiler/sequential_compilation_test.cc; tests/cli/runtests", "Native declaration and invocation AST with attached semantic bindings, nested static calls, include-resolved declarations, and no top-level synthetic declarations; only public function-block methods are implemented; classes, interfaces, inheritance, overrides, properties, and normative 2025 behavior remain unverified", false},
    ...
    {"ED4-ASSERT", "ASSERT(IN : BOOL) : VOID", Family::pou, Status::partially_implemented, "iec61131-3:2025-experimental", Evidence::implementation_verified, Evidence::cross_vendor_provisional, "compiler/modern_library_registry.cc; IEC public 2025 preview; public specialist analysis", "tests/compiler/modern_library_registry_test.cc; tests/cli/runtests", "Released/no-op runtime policy; development notification and normative ABI remain unverified", false}
  };
  return catalog;
}
