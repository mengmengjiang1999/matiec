...
const std::vector<LanguageFeatureRecord> &language_feature_catalog() {
  ...
  static const std::vector<LanguageFeatureRecord> catalog = {
    ...
    {"TYPE-REFERENCE", "REF_TO, REF, DREF, dereference and NULL", Family::reference, Status::partially_implemented, "-r", Evidence::implementation_verified, Evidence::unverified, "stage1_2/iec_bison.yy; stage4/generate_c", "tests/cli/profile-fixtures/reference.st", "Completion and 2025 rules are unverified", false},
    {"TYPE-REFERENCE-EXT", "Non-standard broad reference forms", Family::extension, Status::implemented, "-R", Evidence::implementation_verified, Evidence::unverified, "stage1_2/iec_bison.yy; main.cc", "", "MATIEC extension; no focused maintained test", true},
