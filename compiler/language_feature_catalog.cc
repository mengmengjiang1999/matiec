...
const std::vector<LanguageFeatureRecord> &language_feature_catalog() {
  ...
  static const std::vector<LanguageFeatureRecord> catalog = {
    ...
    {"ED3-NAMESPACE", "Namespaces and qualified names", Family::pou, Status::partially_implemented, "iec61131-3:2025-experimental", Evidence::implementation_verified, Evidence::cross_vendor_provisional, "compiler/namespace_ast_analysis.cc; compiler/namespace_normalizer.cc; stage1_2/iec_bison.yy; absyntax/absyntax.def; public vendor material", "tests/compiler/sequential_compilation_test.cc; compiler/tests/namespace_normalizer_test.cc; tests/cli/runtests", "Native structural AST is authoritative for metadata; a pre-parse spelling bridge remains for legacy lexer classification; normative 2025 lookup, visibility, aliases, reopening, shadowing, and ABI rules are unverified", false},
