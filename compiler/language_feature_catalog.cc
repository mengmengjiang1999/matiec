...
const std::vector<LanguageFeatureRecord> &language_feature_catalog() {
  ...
  static const std::vector<LanguageFeatureRecord> catalog = {
    ...
    {"CONFIG-VAR-ACCESS", "Access variables", Family::configuration, Status::partially_implemented, "iec61131-3:2025-experimental", Evidence::implementation_verified, Evidence::cross_vendor_provisional, "compiler/access_variable_ast.cc; stage1_2/iec_bison.yy; public Beckhoff and OPC Foundation material", "tests/compiler/sequential_compilation_test.cc; tests/cli/runtests", "Native post-parse AST validation supports same-configuration simple VAR_GLOBAL paths and ACCESS.csv export; hierarchical paths, direct addresses, structured elements, and normative 2025 behavior remain unverified", false},
    ...
    {"ED4-ASSERT", "ASSERT(IN : BOOL) : VOID", Family::pou, Status::partially_implemented, "iec61131-3:2025-experimental", Evidence::implementation_verified, Evidence::cross_vendor_provisional, "compiler/modern_library_normalizer.cc; IEC public 2025 preview; public specialist analysis", "compiler/tests/modern_library_normalizer_test.cc; tests/cli/runtests", "Released/no-op runtime policy; development notification and normative ABI remain unverified", false}
  };
  return catalog;
}
