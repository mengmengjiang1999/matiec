...
const std::vector<LanguageFeatureRecord> &language_feature_catalog() {
  ...
  static const std::vector<LanguageFeatureRecord> catalog = {
    ...
    {"ED3-OO", "Object-oriented elements", Family::pou, Status::partially_implemented, "iec61131-3:2025-experimental", Evidence::implementation_verified, Evidence::cross_vendor_provisional, "compiler/object_method_ast_analysis.cc; compiler/object_method_compatibility_ast.cc; compiler/object_method_call_lowering.cc; stage1_2/iec_bison.yy; absyntax/absyntax.def; public Edition 3 vendor material", "tests/compiler/sequential_compilation_test.cc; tests/cli/runtests", "Native declaration and invocation AST with post-parse metadata, compatibility semantic/C lowering, and no method source scan or injection; only public function-block methods with static dispatch are implemented; classes, interfaces, inheritance, overrides, properties, and normative 2025 behavior remain unverified", false},
