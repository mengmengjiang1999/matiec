...
void *enum_declaration_check_c::visit(library_c *symbol) {
  global_enumvalue_symtable = &(symbol->enumvalue_symtable(analysis_));
...
void *enum_declaration_check_c::visit(function_declaration_c *symbol) {
  populate_enumvalue_symtable->populate(&(symbol->enumvalue_symtable(analysis_)), symbol->var_declarations_list);
  return NULL;
}
...
void *enum_declaration_check_c::visit(function_block_declaration_c *symbol) {
  populate_enumvalue_symtable->populate(&(symbol->enumvalue_symtable(analysis_)), symbol->var_declarations);
  return NULL;
}
...
void *enum_declaration_check_c::visit(configuration_declaration_c *symbol) {
  if (NULL != symbol->global_var_declarations)
    populate_enumvalue_symtable->populate(&(symbol->enumvalue_symtable(analysis_)), symbol->global_var_declarations);
  if (NULL != symbol->resource_declarations)
    ...
    populate_enumvalue_symtable->populate(&(symbol->enumvalue_symtable(analysis_)), symbol->resource_declarations);
