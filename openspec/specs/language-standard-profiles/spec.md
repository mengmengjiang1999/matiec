# language-standard-profiles Specification

## Purpose

Define explicit language-version boundaries while preserving MATIEC legacy behavior
and preventing experimental evolution from being mistaken for standards conformance.
